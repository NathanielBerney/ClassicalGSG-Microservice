"""
FastAPI application for ClassicalGSG microservice
"""
...
from ClassicalGSG_handler import ClassicalGSGHandler

app = FastAPI(
    title="ClassicalGSG Microservice",
    description="Molecular property prediction service using ClassicalGSG models",
    version="0.1.0"
)
...
async def health_check() -> HealthResponse:
    return HealthResponse(
        status="Healthy",
        message="ClassicalGSG is running"
    )
